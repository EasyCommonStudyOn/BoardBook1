...
from .utilities import get_timestampt_path, send_new_comment_notification
...
class AdvUser(AbstractUser):
    ...
    def delete(self, *args, **kwargs):
        Bb.objects.filter(author=self).delete()
...
class Bb(models.Model):
    ...
    image = models.ImageField(blank=True, upload_to=get_timestampt_path, verbose_name='Изображение')
    ...
    def delete(self, *args, **kwargs):
        AdditionalImage.objects.filter(bb=self).delete()
        super().delete(*args, **kwargs)
...
class AdditionalImage(models.Model):
    ...
    image = models.ImageField(upload_to=get_timestampt_path, verbose_name='Изображение')
...
def post_save_dispatcher(sender, instance, created, **kwargs):
    if created and instance.bb.author.send_messages:
